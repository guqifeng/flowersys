"""
Django settings for flowersys project.
...
SECRET_KEY = 'au96+qse0pc_c6pmm&oukl4+s$n%1su7k*(=!ylq8z=cs^sc87'
...
WSGI_APPLICATION = 'flowersys.wsgi.application'
